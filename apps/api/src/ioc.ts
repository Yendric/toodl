...
iocContainer.bind<ShareController>(ShareController).toSelf();
...
iocContainer.bind<ListAccessService>(ListAccessService).toSelf();
...
iocContainer.bind<ShareService>(ShareService).toSelf();
