...
export const UserInfoResponse = zod.object({
  ...
  dailyPush: zod.boolean(),
  reminderPush: zod.boolean(),
  nowPush: zod.boolean(),
...
export const TodoIndexResponseItem = zod.object({
  ...
  startTime: zod.iso.datetime({ offset: true }).nullable(),
  endTime: zod.iso.datetime({ offset: true }).nullable(),
...
export const TodoStoreBody = zod.object({
  ...
  startTime: zod.union([zod.string(), zod.iso.datetime({ offset: true })]).optional(),
  endTime: zod.union([zod.string(), zod.iso.datetime({ offset: true })]).nullish(),
...
export const NotificationSubscribeResponse = zod.void();

export const NotificationUnsubscribeBody = zod.object({
  endpoint: zod.string(),
});

export const NotificationUnsubscribeResponse = zod.void();
